...
//                        .anyRequest().authenticated()
                api -> api
                        ...
                        .requestMatchers(HttpMethod.POST, "/manager/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/manager/create-manager").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:7700"));
